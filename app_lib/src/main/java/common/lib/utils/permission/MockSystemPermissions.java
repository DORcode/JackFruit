...
public class MockSystemPermissions {
    ...
    protected MockSystemPermissions() {
        mPermissionsGranted = new ArrayList<String>();
        mPermissionsOkToGrant = new ArrayList<String>();
        mPermissionsNeverAskAgain = new ArrayList<String>();
        mPermissionRequestCount = new HashMap<String,Integer>();
    }
