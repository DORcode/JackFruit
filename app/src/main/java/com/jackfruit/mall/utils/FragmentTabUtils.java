...
public class FragmentTabUtils implements RadioGroup.OnCheckedChangeListener {
    ...
    public FragmentTabUtils(FragmentManager fragmentManager, List<Fragment> fragments, int fragmentContaintId, RadioGroup rgs) {
        this(fragmentManager, fragments, fragmentContaintId, rgs, null);
    }
